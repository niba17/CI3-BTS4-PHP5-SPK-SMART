...
<div class="card-body" style="background-image: url(<?= base_url('assets/atlas/Atlas/'); ?>img/banner-bk.jpg); background-size:cover">
  ...
  <body>
    <div class="row">
      <div class="col-md-6">
        <img class="img-fluid" src="<?= base_url('assets/img/') . $detail['gambar']; ?>" style="width:100%;height:25em;border :5px solid grey;border-radius:5px">
      </div>
      <div class="col-md-6">
          ...
          <table class="table text-center" id="" width="100%" cellspacing="0" style="font-family:  Bahnschrift; color:#ccc">
            <tbody class="text-left font-weight-bold text-white">
              ...
              <tr>
                ...
                <td><?= $detail['r_harga']; ?></td>
              </tr>
              <tr>
                <td>Luas Bangunan</td>
                <td>:</td>
                <td><?= $detail['r_luas'] . 'm<sup>2</sup>'; ?></td>
              </tr>
              <tr>
                <td>Keramaian</td>
                <td>:</td>
                <td><?= $detail['r_keramaian']; ?></td>
              </tr>
              <tr>
                <td>Fasilitas</td>
                <td>:</td>
                <td><?= $detail['r_fasilitas']; ?></td>
              </tr>
              <tr>
                <td>Keamanan</td>
                <td>:</td>
                <td><?= $detail['r_keamanan']; ?></td>
              </tr>
              <tr>
                <td>Jarak Kompetitor</td>
                <td>:</td>
                <td><?= $detail['r_kompetitor']; ?></td>
              </tr>
              <tr>
                <td>Surat Ijin</td>
                <td>:</td>
                <td><?= $detail['r_perijinan']; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
